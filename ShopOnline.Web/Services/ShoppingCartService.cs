...
namespace ShopOnline.Web.Services
{
    public class ShoppingCartService : IShoppingCartService
    {
        ...
        public event Action<int> OnShoppingCrtChanged;
        ...
        public async Task<CartItemDto> DeleteItem(int id)
        {
            try
            {
                var responce = await _httpClient.DeleteAsync($"api/ShoppingCart/{id}");
        ...
        public void RaizeEventOnShppingCartChanged(int totalQty)
        {
            if(OnShoppingCrtChanged != null){
                OnShoppingCrtChanged.Invoke(totalQty);
            }
        }
